...
\chapter[J.S. Bach and \textit{The Well-Tempered Clavier, Book I} BWV 847]{Johann Sebastian Bach – \textit{The Well-Tempered Clavier, Book I Prelude and Fugue in C Minor}, BWV 847 (1722 and 1740)}\label{bach-chapter}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{figures/prelude-tempo-markings.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/bach-prelude-adagio-allegro.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/bach-presto-section.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/bach-prelude-motive-one.png}
