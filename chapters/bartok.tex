...
\begin{figure}
  ...
  \caption[The beginning of ``Pe loc'', in Bartok's \textit{Six Romanian Dances}, Sz. 56, BB 68]{The beginning of ``Pe loc''}  \label{fig:bartok-one-spot-beginning}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{bartok-one-spot-raised-fourth.jpg}
  \caption[The fourth scale degree note E, raised to be E\musSharp{} in ``Pe loc'' of  Bartok's \textit{Romanian Folk Dances}, Sz. 56, BB 68]{The use of the raised fourth scale degree in ``Pe loc''}
  \label{fig:bartok-one-spot-raised-fourth}
\end{figure}
