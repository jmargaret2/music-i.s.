...
\begin{figure}
  ...
  \caption[An example of the open interpretation in ``Brâul'' of Bartok's \textit{Six Romanian Dances}, Sz. 56, BB 68]{Examples of Open Interpretation in ``Brâul''}
...
\begin{figure}
  ...
  \caption[The beginning of ``Pe loc'', in Bartok's \textit{Six Romanian Dances}, Sz. 56, BB 68]{The beginning of ``Pe loc''}  
