...
\begin{acknowl}  
First, the success of both these program notes and my senior recital would not have been possible without my advisor, Dr. Yuka Nakayama-Lewicki, and her incredible support and guidance through the IS process. Her advice and support has made this an enjoyable experience, and I am incredibly grateful to have had the opportunity to work with her both over this past year on a concentrated senior recital repertoire, and over the past four years. I would also like to thank my academic advisor, Dr. Jonathan Guez, for his support both as professor and advisor over the past four years. Also, to the Wooster Music Department, thank you for the suggestions and resources for the successful completion of this project. To Dr. Daniel Knaggs and Dr. Peter Mowrey, I am thankful for your knowledge and contributions to my growth which your classes have provided me. Thank you to Tessa from the Writing Center for her genuine nature, and answering even the silliest of my questions while helping me to de-stress. Thank you to Sam, Joel, and Hawi for helping me to keep my days lively and upbeat while in the depth of my writing. To Yvonne and Dr. Niklas Manz, thank you for teaching my least stressful class during my last year at Wooster. Additionally, thank you to my family for their unwavering support. Without them, I would not have attained the level of success that I have had both inside and outside the classroom, and much of this would not have been possible. Last and certainly not least, thank you to every friend that I have had, and all the fantastic people that I have met along the way. To Andrea, Libby, Stacey, and Katie, thank you for the late nights, and the fun moments when they were needed most. The support of each of these people have been incredibly helpful and uplifting while undertaking the struggles that are part of the IS process, and I am extremely grateful to each of them.
\end{acknowl}
...
\input{chapters/bach}
\input{chapters/mozart}
\input{chapters/beethoven}
\input{chapters/chopin}
\input{chapters/tchaikovsky}
\input{chapters/bartok}
